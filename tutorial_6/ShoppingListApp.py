...
class ShoppingListApp(tk.Tk):
    def __init__(self):
        ...
        self.qty_label = tk.Label(self, text="Item Quantity:")
        self.qty_label.grid(row=2, column=0, sticky="w", padx=10, pady=5)
    ...
    def add_item(self):
        ...
        try:
            ...
            item_qty = int(self.qty_entry.get())
        except ValueError:
            messagebox.showerror("Error", "Invalid price or quantity entered!")
            return

        item = ShoppingItem(item_name, item_price, item_qty)
    ...
    def update_item(self):
        ...
        updated_item = ShoppingItem(item_name, item_price, item_qty)
